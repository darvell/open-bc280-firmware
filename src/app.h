...
/*
 * Apply latest inputs to UI state and control outputs
 *
 * Consolidates button-driven UI actions, profile/gear changes,
 * output recompute, and telemetry/trip updates. Used by the
 * main loop and debug input injection.
 */
