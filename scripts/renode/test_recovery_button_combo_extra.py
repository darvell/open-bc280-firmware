#!/usr/bin/env python3
"""Renode test for MENU+POWER+GEAR long press (should reboot)."""
...
BUTTON_POWER = 0x08
BUTTON_GEAR_UP = 0x10
BUTTON_COMBO = BUTTON_MENU | BUTTON_POWER | BUTTON_GEAR_UP
...
def main() -> int:
    ...
    try:
        ...
        client.set_state(rpm=0, torque=0, speed_dmph=0, soc=80, err=0, buttons=BUTTON_COMBO)
        print("  [OK] Sent MENU+POWER+GEAR long press")
        ...
        print("PASS: recovery combo with gear triggers bootloader reboot")
        return 0
