#!/usr/bin/env python3
"""Renode test for MENU-only short press (should NOT reboot)."""
...
def main() -> int:
    ...
    try:
        ...
        print("  [OK] Sent MENU short press")
        ...
        expect(ms_after >= ms_before, "Unexpected reboot after MENU short press")

        print("PASS: menu-only short press does not reboot")
        return 0
