#!/usr/bin/env python3
"""Renode test for POWER-only short press (should NOT reboot)."""
...
def main() -> int:
    ...
    try:
        ...
        print("  [OK] Sent POWER short press")
        ...
        expect(ms_after >= ms_before, "Unexpected reboot after POWER short press")

        print("PASS: power-only short press does not reboot")
        return 0
